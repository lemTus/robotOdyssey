...
public class PadWhithDriveCmd extends Command {
  ...
  public PadWhithDriveCmd(DoubleSupplier xSupplier, DoubleSupplier ySupplier, DoubleSupplier azimuthSupplier, BooleanSupplier fieldOrientedSupplier, SwerveSubsystem swerveSubsystem) {
